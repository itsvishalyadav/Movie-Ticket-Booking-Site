...
const RefundPolicy = () => {
  return (
    <div className="policy-page">
      ...
      <p>
        VISHAL YADAV believes in helping its customers as far as possible, and has therefore a liberal cancellation policy.
        Under this policy:
      </p>
      ...
      <ul className="policy-list">
        <li>
          ...
          merchants and they have initiated the process of shipping them.
        </li>
        <li>
          VISHAL YADAV does not accept cancellation requests for perishable items like flowers, eatables etc.
        ...
        <li>
          ...
          own end. This should be reported within 1-2 days of receipt of the products.
        </li>
        <li>
          In case you feel that the product received is not as shown on the site or as per your expectations, you must
          bring it to the notice of our customer service within 1–2 days of receiving the product. The Customer
        ...
        <li>
          In case of any Refunds approved by the VISHAL YADAV, it’ll take 1-2 days for the refund to be processed
          to the end customer.
        </li>
      </ul>
    </div>

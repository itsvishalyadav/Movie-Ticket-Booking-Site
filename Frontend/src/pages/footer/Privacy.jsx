  ...
  return (
    <div className={privacyStyles.privacyRoot}>
      ...
      <section className={privacyStyles.privacySection}>
        <h2 className={privacyStyles.privacySectionTitle}>1. What Data We Collect</h2>
        ...
        <h2 className={privacyStyles.privacySectionTitle}>2. How We Use Data</h2>
        <ul className={privacyStyles.privacyList}>
        ...
        <p className={privacyStyles.privacyText}>
          We use industry-standard security measures to protect your data. Your information is encrypted and never sold to third parties.
        </p>
        ...
        <p className={privacyStyles.privacyText}>
          If you have questions about this policy, email us at <a href="mailto:moviebook@gmail.com" className={privacyStyles.privacyLink}>moviebook@gmail.com</a>.
        </p>
      </section>

    ...
    <div className={termsStyles.termsRoot}>
      ...
      <section className={termsStyles.termsHero}>
        ...
        <p className={termsStyles.termsDesc}>
          Please read these terms carefully before using GetMySeat. By using our
          site, you agree to these terms.
        </p>
      </section>
      <section className={termsStyles.termsSection}>
        <h2 className={termsStyles.termsSectionTitle}>
          1. Acceptance of Terms
        </h2>
        <p className={termsStyles.termsText}>
          By accessing or using GetMySeat, you agree to comply with these Terms
        ...
        <ul className={termsStyles.termsList}>
          ...
          <li>
            Tickets are non-transferable and non-refundable unless stated
            otherwise
          </li>
        </ul>
        <h2 className={termsStyles.termsSectionTitle}>
        ...
        <p className={termsStyles.termsText}>
          GetMySeat is not liable for any indirect, incidental, or consequential
        ...
        <p className={termsStyles.termsText}>
          ...
          <a
            ...
            className={termsStyles.termsLink}
          >
